...
function _createMails() {
    ...
    if (!emails || !emails.length) {
        emails = [
            ...
            { id: 'e101', fromEmail: 'alice@example.com', fromFullname: 'Alice Smith', toEmail: 'bob@example.com', toFullname: 'Bob Johnson', subject: 'Meet for lunch', sentAt: new Date('2024-06-06T00:00:00'), isStarred: false, status: 'inbox', body: 'Please join me for lunch today. It has been a while since we last met and I would love to catch up with you. I have ordered a nice dinner for us, so let\'s make it a special occasion. I hope you can make it, I have a few surprises up my sleeve. Let\'s make it a memorable lunch.\n\nBest regards,\nAlice', isRead: true, removedAt: null },
            { id: 'e102', fromEmail: 'bob@example.com', fromFullname: 'Bob Johnson', toEmail: 'alice@example.com', toFullname: 'Alice Smith', subject: 'Re: Meet for lunch', sentAt: new Date('2024-01-02T00:00:00'), isStarred: true, status: 'inbox', body: 'Sure, I will be there at 2pm. I can\'t wait to see you and enjoy the delicious meal you have prepared. Let\'s make this a day to remember. See you soon,\nBob', isRead: false, removedAt: null },
            { id: 'e103', fromEmail: 'charlie@example.com', fromFullname: 'Charlie Brown', toEmail: 'dave@example.com', toFullname: 'Dave Smith', subject: 'Promotion', sentAt: new Date('2024-05-28T05:17:22'), isStarred: false, status: 'inbox', body: 'Congratulations on your promotion! I am thrilled to hear about your success. Your dedication and hard work have not gone unnoticed. I am sure you will continue to excel in your new role. Congratulations to you and Lucy and Snoopy! Let\'s celebrate together.\n\nBest regards,\nCharlie', isRead: false, removedAt: null },
            { id: 'e104', fromEmail: 'dave@example.com', fromFullname: 'Dave Smith', toEmail: 'charlie@example.com', toFullname: 'Charlie Brown', subject: 'Meet for dinner', isStarred: false, status: 'draft', body: 'I have a table reserved at 7pm. I have planned a lovely evening for us, complete with a bottle of fine wine and a selection of delicious dishes. It will be a relaxing and enjoyable evening. Let\'s make the most of it and create lasting memories. See you soon,\nDave', isRead: true, removedAt: null },
            ...
            { id: 'e111', fromEmail: 'kate@example.com', fromFullname: 'Kate Smith', toEmail: 'mike@example.com', toFullname: 'Mike Johnson', subject: 'Meet for dinner', isStarred: false, status: 'draft', body: 'I have a table reserved at 8pm', isRead: false, removedAt: null },
            ...
            { id: 'e116', fromEmail: 'peter@example.com', fromFullname: 'Peter Brown', toEmail: 'lisa@example.com', toFullname: 'Lisa Johnson', subject: 'Meet for dinner', isStarred: false, status: 'draft', body: 'I have a table reserved at 6pm', isRead: false, removedAt: null },
            ...
            { id: 'e121', fromEmail: 'laura@example.com', fromFullname: 'Laura Smith', toEmail: 'harry@example.com', toFullname: 'Harry Johnson', subject: 'Meet for dinner', isStarred: false, status: 'draft', body: 'I have a table reserved at 7pm', isRead: false, removedAt: null },
            ...
            { id: 'e128', fromEmail: 'yolanda@example.com', fromFullname: 'Yolanda Johnson', toEmail: 'peter@example.com', toFullname: 'Peter Brown', subject: 'Meet for dinner', isStarred: false, status: 'draft', body: 'I have a table reserved at 7pm', isRead: false, removedAt: null },
