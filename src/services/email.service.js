...
function _createMails() {
    ...
    if (!emails || !emails.length) {
        emails = [
            ...
            { id: 'e101', fromEmail: 'alice@example.com', fromFullname: 'Alice Smith', toEmail: 'bob@example.com', toFullname: 'Bob Johnson', subject: 'Meet for lunch', sentAt: new Date('2021-01-01'), isStarred: false, status: 'inbox', body: 'Please join me for lunch today', isRead: true, removedAt: null },
            ...
            { id: 'e104', fromEmail: 'dave@example.com', fromFullname: 'Dave Smith', toEmail: 'charlie@example.com', toFullname: 'Charlie Brown', subject: 'Meet for dinner', sentAt: new Date('2021-01-04'), isStarred: false, status: 'draft', body: 'I have a table reserved at 7pm', isRead: true, removedAt: null },
